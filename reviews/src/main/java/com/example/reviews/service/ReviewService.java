    ...
    public void seed() {
        ...
        if (reviewRepository.count() == 0) {
            List<Review> reviews = List.of(
                    new Review(5.0, 10L, ReviewStatus.APPROVED, "Amazing visuals!", 1L, 1L),
                    new Review(4.5, 7L, ReviewStatus.APPROVED, "Very thought-provoking.", 2L, 2L),
                    new Review(4.0, 3L, ReviewStatus.PENDING, "Nice concept, a bit confusing.", 3L, 3L),
                    new Review(3.8, 2L, ReviewStatus.APPROVED, "Good movie, but overhyped.", 1L, 1L)
            );
