    ...
    public void seed() {
        ...
        if (notificationRepository.count() == 0) {
            List<Notification> notifications = List.of(
                    new Notification("Interstellar is now streaming!", NotificationType.LIKEDREVIEW, false, 1L, 1L),
                    new Notification("The Matrix sequel announced!", NotificationType.NEWMOVIE, false, 2L, 2L),
                    new Notification("Inception added to your watchlist", NotificationType.NEWREVIEW, false, 3L, 3L),
                    new Notification("Don't miss Interstellar this weekend!", NotificationType.LIKEDREVIEW, false, 1L, 1L)
            );
